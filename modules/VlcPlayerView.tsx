...
import type { VlcPlayerSource, VlcPlayerViewProps, VlcPlayerViewRef } from './VlcPlayer.types';
...
const VlcPlayerView = React.forwardRef<VlcPlayerViewRef, VlcPlayerViewProps>((props, ref) => {
  ...
  const processedSource: VlcPlayerSource =
    typeof source === 'string' ? ({ uri: source } as unknown as VlcPlayerSource) : source;
...
VlcPlayerView.displayName = 'VlcPlayerView';
